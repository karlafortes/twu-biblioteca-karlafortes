...
public class BooksLibrary {
    ...
    private static BooksLibrary booksLibraryInstance = new BooksLibrary();

    private BooksLibrary() {
        this.books = books;
    }

    public static BooksLibrary getBooksLibrary() {
        return booksLibraryInstance;
    }
